...
lista_musicas = [
    ...
    ("The World We Knew (Over And Over)", "Frank Sinatra", "Jazz"),
    ("deep in it", "berlioz, Ted Jasper", "Jazz"),
    ("I Wish You Love - 2004 Remastered/Remixed", "Nancy Wilson", "Jazz"),
    ...
    ("Fly Me To The Moon (In Other Words)", "Frank Sinatra, Count Basie", "Jazz"),
    ...
    ("Dream A Little Dream Of Me - Single Version", "Ella Fitzgerald, Louis Armstrong", "Jazz"),
    ...
    ("These Foolish Things (Remind Me Of You)", "Ella Fitzgerald, Louis Armstrong", "Jazz"),
    ...
    ("I've Got You Under My Skin - Remastered 1998", "Frank Sinatra", "Jazz"),
    ("Theme From New York, New York - 2008 Remastered", "Frank Sinatra", "Jazz"),
    ("Blue Moon", "Billie Holiday, Oscar Peterson, Studio ensemble", "Jazz"),
    ("It's Been a Long, Long Time (with Harry James & His Orchestra)", "Kitty Kallen, Harry James", "Jazz"),
    ...
    ("Smile - Mono / 1954 Version / Remastered 1992", "Nat King Cole", "Jazz"),
    ...
    ("Ovelha Negra - Ao Vivo", "Rita Lee", "MPB"),
    ...
    ("Tropicana (Morena Tropicana)", "Alceu Valença", "MPB"),
    ...
    ("Como uma onda - Zen-surfismo", "Lulu Santos", "MPB"),
    ("Não Quero Dinheiro (Só Quero Amar)", "Tim Maia", "MPB"),
    ...
    ("Tears in Heaven - Acoustic; Live at MTV Unplugged, Bray Film Studios", "Eric Clapton", "Rock"),
    ...
    ("Don't Stop Me Now - ...Revisited", "Queen", "Rock"),
    ("Let It Be - Remastered 2009", "The Beatles", "Rock"),
    ("The Show Must Go On", "Queen", "Rock"),
    ("In My Life - Remastered 2009", "The Beatles", "Rock"),
    ("Hotel California - Live On MTV, 1994", "Eagles", "Rock"),
    ("Knockin' On Heaven's Door", "Guns N' Roses", "Rock"),
    ("Livin' On A Prayer", "Bon Jovi", "Rock"),
    ("Here Comes The Sun - Remastered 2009", "The Beatles", "Rock"),
    ...
    ("Shadows Of Our Evening Tides (Radio Edit)", "Alex Henry Foster, Allen Ginsberg", "Rock"),
